...
export default [
	{
		...
		received: stringifyDifference({
			index: 0,
			item: { kind: "E", lhs: "🟢", rhs: "❌" },
			kind: "A",
			path: ["🟢"],
		}),
		wanted: `${foregroundCyan`🟢`}.${foregroundCyan`0`} has the wrong value. Wanted ${foregroundBrightRed`"🟢"`} but received ${foregroundBrightRed`"❌"`}.`,
	},
	{
	...
	},
	{
		...
		wanted: `${foregroundCyan`🟢`}.${foregroundCyan`🟩`} has the wrong value. Wanted ${foregroundBrightRed`"🟢"`} but received ${foregroundBrightRed`"❌"`}.`,
	},
	{
		...
		wanted: `${foregroundCyan`🟢`}.${foregroundCyan`🟩`} was set with value ${foregroundBrightRed`"🟢"`}.`,
	},
	{
